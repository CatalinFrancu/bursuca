/**
 * Dummy strategy injected with all sorts of bugs
 **/
#include <stdio.h>
#include <stdlib.h>
...
// bug timing (all turns are 1-based)
#define BAD_MOVE_AT_TURN 100000
#define CRASH_AT_TURN 100000
#define LOOP_AT_TURN 100000
#define LOOP_AT_END true
